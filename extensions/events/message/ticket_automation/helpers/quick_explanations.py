# extensions/events/message/ticket_automation/helpers/quick_explanations.py
"""
Quick explanation handlers for FWA and Zen concepts in ticket channels.
Automatically sends informational content when users ask "What is FWA" or "What is Zen".
"""
...
async def send_fwa_quick_explanation(
        bot: hikari.GatewayBot,
        channel_id: int
):
    """
    Send FWA explanation to a ticket channel.

    Args:
        bot: The bot instance for sending messages
        channel_id: Channel to send the explanation to
    """
    components = [
        Container(
...
async def send_zen_quick_explanation(
        bot: hikari.GatewayBot,
        channel_id: int
):
    """
    Send Zen explanation to a ticket channel.
