...
async def explanations(
    ...
    **kwargs
    ...
    if choice == "what_is_zen":
        components = [
            Text(content=f"<:BabyYoda:1390465217997312234> **Zen War Clans: A Quick Overview** · {user.mention}"),
            Container(
        ...
        components = [
            ...
            Container(
                ...
                components=[
                    ...
                    Media(
                        items=[
                            MediaItem(media="https://res.cloudinary.com/dxmtzuomk/image/upload/v1751616880/Default_FWA_Base.jpg")
                        ]),
                    Text(content=f"_Requested by {ctx.user.display_name}_")
                ]
            )
        ...
        components = [
            ...
            Container(
                ...
                components=[
                    ...
                    Media(
                        items=[
                            MediaItem(media="https://res.cloudinary.com/dxmtzuomk/image/upload/v1751617812/Warriors_United.gif")
                        ]),
                    ActionRow(
                        components=[
                            LinkButton(
